    ...
    )
{
    ...
    override fun process(request: HttpRequestPort): CompletableFuture<HttpContext> =
        process(HttpContext(HttpCall(request = request), predicate))
            .thenApply {
                val event = it.event
