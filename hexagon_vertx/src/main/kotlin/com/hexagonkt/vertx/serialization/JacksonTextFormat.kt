...
import com.hexagonkt.vertx.serialization.JacksonHelper.createObjectMapper
import com.hexagonkt.vertx.serialization.mapper as serializationMapper
...
internal open class JacksonTextFormat(
    ...
    private val mapper =
        if (factoryGenerator == null) serializationMapper
