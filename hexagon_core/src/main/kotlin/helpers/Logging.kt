...
fun Logger.trace(message: () -> Any?) {
    if (this.isTraceEnabled) this.trace(message().toString())
}

fun Logger.debug(message: () -> Any?) {
    if (this.isDebugEnabled) this.debug(message().toString())
}

fun Logger.info(message: () -> Any?) {
    if (this.isInfoEnabled) this.info(message().toString())
}

fun Logger.warn(message: () -> Any?) {
    if (this.isWarnEnabled) this.warn(message().toString())
}

fun Logger.error(message: () -> Any?) {
    if (this.isErrorEnabled) this.error(message().toString())
}
...
fun <T> Logger.time(message: Any?, block: () -> T): T = this.time({ message }, block)
