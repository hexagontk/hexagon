    ...
    publications {
        ...
        createPomPublication("kotlin_pom") { pomDom ->
            ...
            properties.set(mapOf(
                ...
                "junit.version" to libs.versions.junit.get(),
                "jlink.phase" to "none",
                "jlink.launcher" to $$"${project.name}=${project.artifactId}/${main.class}",
                "shade.phase" to "none",
                "shade.output" to $$"${project.build.directory}/${project.build.finalName}-all.jar",
                "native.build.skip" to true.toString(),
                "native.tests.skip" to false.toString(),
                ...
                "maven-jar-plugin.version" to "3.5.0",
