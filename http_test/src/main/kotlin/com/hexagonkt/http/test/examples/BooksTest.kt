...
abstract class BooksTest(
    ...
    private val path: PathHandler = path {
        ...
        post("/books") {
            val author = queryParameters["author"]?.valueString() ?: return@post badRequest("Missing author")
            val title = queryParameters["title"]?.valueString() ?: return@post badRequest("Missing title")
