...
internal class HttpPartTest {
    ...
    private val fullPart = HttpPart(
        name = "name",
        body = "content",
        headers = multiMapOf("header" to "value"),
    ...
    @Test fun `Full part contains expected values`() {
        ...
        assertEquals(multiMapOf("header" to "value"), fullPart.headers)
    ...
    @Test fun `Minimum part contains expected values`() {
        ...
        assertEquals(MultiMap(emptyMap()), minimumPart.headers)
    ...
    @Test fun `Utility constructors work properly`() {
        HttpPart("key", "value").let {
            ...
            assertEquals(MultiMap(emptyMap()), it.headers)
    ...
    @Test fun `Part comparison works ok`() {
        ...
        assertNotEquals(part, part.copy(headers = multiMapOf("a" to "b")))
