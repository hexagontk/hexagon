...
import com.hexagonkt.templates.freemarker.FreeMarkerAdapter.render
...
internal class FreeMarkerAdapterTest {
    ...
    @Test fun `Templates with context are rendered properly`() {
        ...
        val html = render(URL(resource), context, locale)
    ...
    @Test fun `Dates are converted properly`() {
        ...
        val html = render(URL("classpath:templates/test_dates.freemarker.html"), context, locale)
