...
open class JmhBenchmark {
    ...
    private suspend fun <T : Any> Handler<T>.process(event: T): T =
    ...
    @Benchmark fun beforeAndAfterHandlersAreCalledInOrder(bh: Blackhole) = runBlocking {
    ...
    @Benchmark fun filtersAllowPassingAndHalting(bh: Blackhole) = runBlocking {
        // Filter passing
