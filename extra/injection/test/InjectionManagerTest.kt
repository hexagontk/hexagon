...
import com.hexagontk.injection.InjectionManager.module
...
internal class InjectionManagerTest {
    ...
    fun `DI just works`() {
        ...
        injector.apply {
            ...
            assert(module.toString().contains("com.hexagontk.injection.Foo"))
            assert(module.toString().contains("com.hexagontk.injection.Bar"))
        }
    }
